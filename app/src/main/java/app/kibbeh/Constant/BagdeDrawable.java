...
/**
 * Created by Ravi archi on 5/15/2017.
 */

public class BagdeDrawable extends Drawable {
    ...
    public BagdeDrawable(Context context) {
        ...
        mBadgePaint1.setColor(ContextCompat.getColor(context.getApplicationContext(), R.color.blue));
